CREATE TABLE vozilo (
  id_vozilo INTEGER UNSIGNED  NOT NULL   AUTO_INCREMENT,
...
CREATE TABLE korisnik (
  ...
  vozilo_id_vozilo INTEGER UNSIGNED  NOT NULL  ,
...
INDEX korisnik_FKIndex2(vozilo_id_vozilo),
  FOREIGN KEY(uloga_id_uloga)
    REFERENCES uloga(id_uloga)
      ON DELETE NO ACTION
      ON UPDATE NO ACTION,
  FOREIGN KEY(vozilo_id_vozilo)
